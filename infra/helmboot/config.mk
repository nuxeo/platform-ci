stack-config: github-config
stack-config: boot-secrets-config
...
boot-secrets-config:
	@:$(call check-variable-defined,admin-username admin-password hmac-token git-user git-email git-token)
