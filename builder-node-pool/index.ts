...
const controlPlaneRef = `${org}/jxlabs-nos-cluster/${env}`;

const controlPlaneStackRef = new pulimi.StackReference(controlPlaneRef);
...
const builderNodePool = new gcp.container.NodePool("builder", {
    ...
    cluster: controlPlaneStackRef.getOutput("cluster"),
    management: {
