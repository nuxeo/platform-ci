...
|--------------------------------------------|----------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------|
| `namespace`                                | Helm release namespace                                                                       | `nil`                                                                                                                                           |
...
| `nexus.docker.registries[0].name`          | Name of the Docker registry                                                                  | `docker`                                                                                                                                        |
| `nexus.docker.registries[0].port`          | Port for the Docker registry service                                                         | `80`                                                                                                                                            |
| `nexus.docker.registries[0].targetPort`    | Target port for the Docker registry service                                                  | `8081`                                                                                                                                          |
| `nexus.docker.registries[0].ingress.annotations`| Annotations to enhance Docker ingress configuration                                     | `{}`                                                                                                                                            |
| `nexus.docker.registries[0].ingress.host`  | Host for the Docker registry                                                                 | `nil`                                                                                                                                           |
| `nexus.docker.registries[0].ingress.path`  | Path for Docker ingress rules.                                                               | `/(.*)`                                                                                                                                         |
| `nexus.docker.registries[0].ingress.secretName` | TLS Secret Name for the Docker ingress                                                  | `registrySecret`                                                                                                                                |
...
| `nexus.nexusPort`                          | Port for Nexus Repository service                                                            | `80`                                                                                                                                            |
| `nexus.nexusTargetPort`                    | Internal port for Nexus Repository service                                                   | `8081`                                                                                                                                          |
...
| `secret.subPath`                           | Subpath to mount the secret                                                                  | `nil`                                                                                                                                           |
...
| `podDisruptionBudget.minAvailable`         | PodDisruptionBudget `minAvailable`                                                           | `1`                                                                                                                                             |
